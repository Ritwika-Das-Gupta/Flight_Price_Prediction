...
def load_saved_artifacts():
    ...
    with open('./artifacts/columns.json','r')as f:
        ...
        __dep = __data_columns[6:11]
        __source = __data_columns[11:16]
        __des = __data_columns[16:21]
        __stops = __data_columns[21:23]
        __arri = __data_columns[23:28]
        __cls = __data_columns[28:29]
    with open('./artifacts/Flight_price_prediction_model.pickle','rb') as f:
